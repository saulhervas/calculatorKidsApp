...
import com.saulhervas.calculatorkidsapp.databinding.FragmentSubtractionBinding
...
class SubtractionFragment : Fragment() {
    ...
    override fun onCreateView(
            ...
            if (userInput.isNotEmpty()) {
                try {
                    ...
                    if (result == userResult) {
                        findNavController().navigate(R.id.action_subtractionFragment_to_checkSplash)
                    } else {
                        findNavController().navigate(R.id.action_subtractionFragment_to_failSplash)
                    }
                    generateNewNumbers()
                    hideKeyboard()
        ...
        binding.imageButton.setOnClickListener {
            findNavController().navigate(R.id.action_subtractionFragment_to_mainFragment)
        }
        return binding.root
    }
